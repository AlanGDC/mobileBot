...
#  Happy Path:
  ...
  Scenario: Usuario realiza flujo de primer pago para un pago de domesticas con CUIL
    ...
    And   usuario completa el campo campo de texto con el valor 20334446660
    And   usuario selecciona Continuar
    And   usuario completa el campo campo de texto con el valor 20334446761
    And   usuario selecciona Continuar
    And   usuario completa el campo campo de texto con el valor 042019
    And   usuario selecciona Continuar
    And   usuario selecciona Continuar
...
#  Validaciones de errores y alertas
  Scenario: Usuario intenta realizar un pago de domesticas con Fecha Invalida
    ...
    And   usuario completa el campo campo de texto con el valor 20334446660
    And   usuario selecciona Continuar
    And   usuario completa el campo campo de texto con el valor 20334446661
    And   usuario selecciona Continuar
    And   usuario completa el campo campo de texto con el valor 052019
    And   usuario selecciona Continuar
    Then  sistema muestra texto Ha ocurrido un error inesperado
