...
Feature: Error en pago masivo
  ...
  @BDSD-2536_HappyPath
  Scenario: Usuario selecciona opción de pago masivo, elige más de un servicio y confirma pago.
  ...
  Sistema me permite acceder al detalle de cuál fue el error y por qué.
    ...
    And   sistema muestra elemento Mensaje de pago con texto Pagaste 3 servicios
    ...
    Then  sistema muestra el mensaje EdenorConFactNoEditable de Edenor por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
  ...
  Sistema me permite acceder al detalle de cuáles fueron los errores y por qué.
    ...
    And   usuario selecciona Mensaje de error de pago
    Then  sistema muestra el mensaje EdenorConFactNoEditable de Edenor por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
    And   sistema muestra el mensaje Edenor1 de Edenor por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
    And   sistema muestra el mensaje VisaConFact de Visa por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
  ...
  Sistema me permite reintentar el pago, acceder al detalle de cuáles fueron los errores y por qué.
    ...
    And   sistema muestra el mensaje Edenor1 de Edenor por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
    And   sistema muestra el mensaje VisaConFact de Visa por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
    And   sistema muestra el mensaje Multa140EditableAny de Multa 140 por un valor de 10055 pesos con vencimiento el 04/12/21 no pudo ser abonado
  ...
  Scenario: Usuario selecciona opción de pago masivo, elige más de un servicio y confirma pago.
  Sistema presenta una congrats con warning de error 47 en un pago.
  Sistema me permite acceder al detalle de cuál fue el error y por qué.
    Given Reset wiremock
    And   Get to wiremock /PaymentsErrors47
    When  usuario accede a pagos
